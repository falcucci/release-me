...
It's just useful scripts to make our work when we talk about changelogs, releases and build automation. It also could be a `gist` obviously but I want put other scripts related of it as I need here.
